...
public class OrderStatusGivenByAdminTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		driver2.findElement(By.xpath("//a[@href=\"view_order.php?user_upd=2\"]")).click();
		driver2.findElement(By.xpath("//button[text()='Update Order Status']")).click();
	}
